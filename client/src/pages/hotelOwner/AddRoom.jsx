...
const AddRoom = () => {
  ...
  return (
    <form>
        <Title align='left' font='outfit' title='Add Room' subTitle='Fill in your room details carefully—include accurate pricing, amenities, and descriptions. This helps guests book with confidence and improves their experience.'/>
        {/* Upload Area For Images*/}
        <p className='text-gray-800 mt-10'>Images</p>
        <div className='grid grid-cols-2 sm:flex gap-4 my-2 flex-wrap'>
            {Object.keys(images).map((key)=>(
                <label htmlFor={`roomImage${key}`} key={key}>
                    <img className='max-h-20 cursor-pointer opacity-80'
        ...
        <p className='text-gray-800 mt-4'>Amenities</p>
         ...
         <button className='bg-blue-600 text-white px-8 py-2 rounded mt-8 cursor-pointer hover:bg-blue-700 transition-colors'>
            Add Room
         </button>
    </form>
  )
