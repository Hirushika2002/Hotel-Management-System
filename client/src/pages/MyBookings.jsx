...
const MyBookings = () => {
  ...
  return (
    <div className='py-28 md:pb-32 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32'>
        <Title title="My Bookings" subtitle='Plan and track your stays with ease. View reservations, manage changes, and stay organized in just a few clicks.' align='left'/>
